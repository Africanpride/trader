...
"[project]/node_modules/@react-email/tailwind/dist/index.mjs [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function dl() {
    ...
    function s(t) {
        return ("TURBOPACK compile-time truthy", 1) ? Buffer.from(t, "base64").toString() : ("TURBOPACK unreachable", undefined);
    }
    class c {
        constructor(e, r){
            if (r.map === !1) return;
...
`), v = w.length - d) : v += w.length, y && x !== "start") {
        ...
        toBase64(o) {
            return ("TURBOPACK compile-time truthy", 1) ? Buffer.from(o).toString("base64") : ("TURBOPACK unreachable", undefined);
        }
        toFileUrl(o) {
...
function sr(u, a) {
    const h = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].Children.map(u, (p)=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isValidElement(p)) {
            const l = {
                ...p.props
            };
            p.props.children && !yl(p) && (l.children = sr(p.props.children, a));
            const f = a(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].cloneElement(p, l, l.children));
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isValidElement(f) && (typeof f.type == "function" || // @ts-expect-error - we know this is a component that may have a render function
            f.type.render)) {
...
const Vu = (u)=>{
    ...
    return {
        elementWithInlinedStyles: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].cloneElement(u, f, f.children),
...
const Sc = ({ children: u, config: a })=>{
    ...
    let l = [], f = !1, s = sr(u, (c)=>{
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidElement"])(c)) {
    ...
    if (ku(p), f) {
        ...
        if (s = sr(s, (t)=>{
            if (c) return t;
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidElement"])(t) && t.type === "head") {
                c = !0;
                const e = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])("style", {
                    children: Ou(p.toString().trim())
                });
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cloneElement"])(t, t.props, t.props.children, e);
            }
            return t;
...
//# sourceMappingURL=node_modules_%40react-email_tailwind_dist_index_mjs_49561ab8._.js.map